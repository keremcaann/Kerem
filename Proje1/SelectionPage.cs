...
namespace Proje1
{
    public partial class SelectionPage : Form
    {
        ...
        private void btnBuy_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("İsim Girmeniz Gerekiyor.","Sistem Mesajı", MessageBoxButtons.OK);
            ...
            if (chairs.Count == 0)
            {
                MessageBox.Show("En az 1 koltuk seçmeniz gerekiyor.", "Sistem Mesajı", MessageBoxButtons.OK);
                return;
            }
